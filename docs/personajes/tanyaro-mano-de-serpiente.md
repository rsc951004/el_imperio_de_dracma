<!--
REGLA EDITORIAL DEL HILO:
Todo el lore confirmado sobre Tanyaro Mano de Serpiente durante este hilo se registra exclusivamente en esta ficha. No debe propagarse a otras fichas ni documentos canónicos. Las únicas excepciones son el enlace estructural obligatorio de docs/personajes.md y el registro editorial obligatorio de docs/notas.md.
-->

<!-- CANON-VELADO: INICIO | desconocido-por: el mundo en general -->
# Tanyaro Mano de Serpiente
...
Un **Portador Siniestro** es un portador capaz de crear criaturas nacidas del miedo y del pensamiento humano.

Un **Portador del Deseo** es un portador capaz de materializar los anhelos de las personas.

Algunos portadores pueden imbuir su poder en objetos o materiales hasta formar algo nuevo.

## Origen

Nació en un lugar desconocido, fuera de Astria y Erebia.
...
- **Genjari:** hermana, amante y Portadora del Deseo. Llegó con él a Stigria.
- **Kaimaro:** padre de Tanyaro y Genjari. Los persiguió hasta Stigria y asesinó a Tanyaro. Genjari lo mató después.
<!-- CANON-VELADO: FIN -->
