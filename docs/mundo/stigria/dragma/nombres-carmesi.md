# Nombres de los Dominios Carmesíes

Esta guía rige los nombres de personas y casas de los territorios Carmesíes y
...
1. Un nombre puede partir de una raíz rumana o búlgara reconocible, pero debe
   recibir cambios leves de letras, sílabas o grafías para no coincidir sin más
   con un nombre real.
2. Las transformaciones deben conservar una lectura clara en español neutro.
3. No se traducen ni se someten a castellanizaciones excesivas: el resultado
...
Esta guía se aplica a nombres nuevos y a la revisión de nombres fundadores
antes de crear fichas. Ningún nombre canónico existente se modifica de forma
automática: toda corrección retroactiva requiere una decisión explícita y una
nota editorial.
