...
|-------|-------|
| **Nombre** | Mormund |
| **Tipo** | Antigua casa imperial; actualmente casa noble de Zephyrya |
| **Origen antiguo** | Clan gheran de Eldenheim |
| **Identidad histórica** | Sangre de Hierro |
| **Lema** | Pendiente |
| **Escudo** | Pendiente |
| **Título histórico** | Emperador de Dragma |
...
La Casa Mormund mantiene su tradición de nombres gheran y no adopta la convención onomástica de Zephyrya.

## Miembros relevantes

- **Wolfram el Bardo:** jefe antiguo del clan.
- **Harald Mormund:** primer emperador de Dragma.
- **Vilem Mormund:** autor de la Concordia.
- **Aldric Mormund:** último emperador de la dinastía.
- **Armin Mormund:** noble y espadachín actual.
