...
| 2026-07-13 | **Reorganización geográfica: 4 zonas de El Gerin.** El antiguo Bloque del Amanecer se divide en tres zonas culturales: Reinos del Verano (3, grecolatinos), Reinos Orientales (2, eslavos) y Reinos del Valle (3, céltico-nórdicos). El Bloque de Hierro se mantiene como Reinos de Hierro (4, germánicos). En la guerra civil, «Bloque de Hierro» y «Bloque del Amanecer» siguen designando las facciones históricas. Alesya documentada como «el cuarto reino del Verano» (protectorado, no reino). Directorios renombrados: lumaria→lumyria, zefiria→zefyria. 17 archivos actualizados: mundo.md, 12-reinos.md, personajes.md, 3 fichas de reino, 6 fichas de monarcas. |
