...
| 2026-07-11 | **Títulos reales asignados a los 12 reinos.** Cada casa reinante recibe un título ceremonial: Acero (Stalgard), Martillo (Skarngard), Llama (Brenngard), Tormenta (Sturmgard), Alba (Lumaria), Montaña (Veleskaria), Viento (Zefiria), Mar (Vesperia), Oro (Aurelia), Tridente (Elyria), Abismo (Sindria), Bosque (Ylvaria). Forma abreviada entre monarcas (Rey Acero, Reina Tormenta, etc.). Sección añadida a fichas individuales, `docs/mundo.md` y `docs/12-reinos.md`. |
| 2026-07-11 | **Tres reinos descienden de Suntaris.** Lumaria (el alma — mística Solaris y Triple Corona), Zefiria (el arte — Casa Solaris sin corona y técnica del viento de Lorian), Elyria (la sangre — marinos originales del puerto suntariano). Añadido a fichas individuales, `docs/12-reinos.md` (nueva sección «Los tres reinos de Suntaris») y `docs/mundo.md`. Veleskaria queda fuera: es reino minero al sureste, sin linaje Suntaris. |
...
| 2026-07-12 | **Nombres valgard (-gard) de los 8 reinos del Amanecer corregidos.** Regla: -gard reemplaza -ria o -aria. Lumaria→Lumagard, Veleskaria→Veleskagard, Zefiria→Zefigard, Vesperia→Vespergard, Aurelia→Aurelgard, Elyria→Elygard, Sindria→Sindgard, Ylvaria→Ylvagard. Son los nombres imperiales bajo el Raikim. |
| 2026-07-12 | **«Bloque del Verano» renombrado a «Bloque del Amanecer».»** Los 8 reinos rebeldes son el Bloque del Amanecer. «Reinos del Verano» queda reservado para los 3 descendientes de Suntaris (Lumaria, Zefiria, Elyria). Corrección aplicada en todas las fichas, mundo.md, 12-reinos.md, personajes.md y fichas de monarcas. |
...
| 2026-07-12 | **Primera dinastía imperial: Casa Mormund.** Electa por el Gran Syndrion en las ruinas de Eldengard. Cinco personajes creados con fichas individuales: Harald (fundador), Roderic (subyugador de dominios rebeldes), Godric (la tragedia fratricida), Mijail (Príncipe Heredero caído, fundador secreto de Casa Tormak en Kardan), Ilena (princesa asesinada), Vilem (Padre del Imperio, arquitecto de la Concordia, tuerto). Linaje con sonoridad germánica = linaje Val marcado. Dragma ha tenido 3 casas imperiales: Mormund, una segunda pendiente, y Pavel (actual). |
| 2026-07-12 | **Gran Syndrion de Dracma.** Asamblea histórica emplazada en la planicie bajo el Monte Dracma sobre las ruinas de Eldengard. Eligió a Harald Mormund como primer emperador. Reformada por la Concordia: ampliada a nobles y comunes (sin reyes), función limitada a ratificar cambios de dinastía. |
...
| 2026-07-12 | **Segunda dinastía imperial: Casa Amschel.** Canónizada. Casa noble de Lumaria (raíz hebrea). 21 emperadores en total. Primer emperador: Ezra Amschel (electo por el Syndrion). Último emperador: Amós Amschel (hijos rehusaron el trono, provocó quiebre de dinastía). Ficha creada en `dinastia-amschel.md`. |
...
| 2026-07-12 | **Mecanismo de quiebre de dinastía.** Codificado en la Concordia (Art. VIII bis). Tres causas: sin hijos, hijos no aprobados, hijos que abdican. Dex Tábura ofrece última oportunidad con pariente de sangre. Si falla, Syndrion elige por mayoría simple. Casa saliente retorna a estatus previo. Documentado en `concordia.md`, `syndrion.md` y `dragma.md`. |
...
| 2026-07-12 | **Syndrion: historial de quiebres documentado.** Tabla con los dos quiebres históricos (Mormund → Amschel, Amschel → Pavel) y sus causas. |
