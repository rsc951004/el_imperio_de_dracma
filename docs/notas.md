...
| 2026-07-16 | **Historia antigua de Stigria canonizada.** Documentados los stigrios, la Gran Devoración, los Grimmen, la tradición de Ghera y Smürr, el origen tradicional de Stomur, el pueblo Gheran, la Edad del Bronce, las nueve regiones, Eldengard, el Surgimiento y la primera invasión. Val deja de ser un pueblo: Val el Terrible es el caudillo que origina a los Sangre de Hierro y al clan Valgard. Renombradas las fichas de Gherin, Stomur y Ghera; creadas fichas para la historia antigua, los Gheran, Smürr y los Grimmen. La identidad de los invasores, la era posterior, la transición de clanes a casas y la etimología de Skarngard quedan pendientes. No se reescribió Malakia; solo se actualizó un enlace a la ficha renombrada de Stomur. La referencia original `boceto-stigria.png` se conservó sin cambios y su corrección se guardó como `boceto-stigria-v2.png`. |
...
| 2026-07-16 | **Stigria geográfica anterior al Rey Podrido.** Establecido que `referencias-visuales/stigria/boceto-stigria.png` representa el continente antes de la definición de reinos y fronteras políticas. Actualizados los nombres históricos de la división Val: El Grimm, Biss, Flemmen, Dresk, Weissen, Rauven, Eisen, Gulden, lago Rost, Stomur y Mahren; se conservan Sturm, Reichstal, Durr, Riss y Undland. Actualizadas las fichas `stigria.md` y `gerin.md`, el índice `mundo.md` y la documentación de la referencia visual. |
| 2026-07-15 | **Geografía tradicional Val de El Gerin.** Reescrita `docs/mundo/stigria/gerin.md` para sustituir la antigua cuadrícula política por divisiones geográficas anteriores a los reinos. Documentados el Paso del Oriente —Flemen, Falkenmeer, Felsmasse, Kaltgrund, Estomur quebrado y Seelental— y las tres franjas centrales —Sturm, Skarn, Waffe, lago Mittel, Reichstal, Durr, Riss y Undland—. La organización política futura del Paso del Oriente permanece fuera de esta definición geográfica. Actualizados `estomur.md` y el índice `mundo.md`. |
