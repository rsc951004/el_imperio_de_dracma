...
| 2026-07-11 | **Los 12 Reinos de Dragma canonizados.** Creadas fichas individuales para los 12 reinos (Stalgard, Skarngard, Brenngard, Sturmgard, Lumaria, Veleskaria, Zefiria, Vesperia, Aurelia, Elyria, Sindria, Ylvaria) en `docs/mundo/estigria/dragma/` a partir de `docs/12-reinos.md`. Veleskaria actualizada: Casa Kestrel → Casa Enescu según 12-reinos.md. Índice de `docs/mundo.md` actualizado con tabla completa de reinos, bloques, casas y gobernantes. |
